...
namespace binarytree_CSharp
{
  internal class Program
  {
    static void Main(string[] args)
    {
      ...
      Console.WriteLine("BST by Nhep Ponhrith (no duplicate allowed).");
      while (choice != 'q')               //interact with user
      {                                   //until user types 'q'
        Console.WriteLine("Enter first letter of your choice.");
        Console.WriteLine("zFindMax, show, insert, find, traverse or quit.");
        ...
        switch (choice)
        {
          ...
          case 'z':
            ...
            int answer =  theTree.findMax();
            Console.WriteLine("The largest integer in the BST " + answer);
            break;
          default:
